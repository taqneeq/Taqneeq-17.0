...
const index = () => {
  return (
    ...
    >
        <hr className="w-1/2 border-4 absolute top-10 -left-1/4 text-brandOffWhite opacity-70"></hr>
        <h1 className="font-BSD text-5xl text-white absolute top-5 left-1/4 ml-4">/ [ About ]</h1>
        <div className="flex flex-row justify-center items-center relative md:gap-10 mx-auto">
            <img src='/astronaut.svg' alt="filler image" width="30%"></img>
            <p
            className="md:text-base font-ibm max-w-prose md:text-justify md:[text-align-last:right]"
            >
